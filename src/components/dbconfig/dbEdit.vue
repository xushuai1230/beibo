    ...
    <div class="db-edit-content">
      <ul class="db-content-list">
        <li>
          ...
          <el-select v-model="sourceValue" value="sourceValue" placeholder="请选择">
            <el-option
        ...
        <li>
          <span>账号:</span>
          <el-input v-model="username" value="username" placeholder="请输入账号"></el-input>
        </li>
        <li>
          <span>密码:</span>
          <el-input v-model="password" value="password" placeholder="请输入密码"></el-input>
        </li>
        <li>
          <span>baseName:</span>
          <el-select v-model="baseValue" value="baseValue" placeholder="请选择">
  ...
  methods: {
    getSource() {
      ...
      this.baseValue = this.editId.DataBase;
       console.log("222222", this.sourceValue,this.serverValue);
